...
import { setNickname } from '../utils/userSlice';
...
export default function NickFormScreen({ navigation }) {
    const userData = useSelector((state) => state.userData);
    const dispatch = useDispatch();

    const [nick, setNick] = React.useState(userData.nickname);
                ...
                >
                    <SafeAreaView style={{ alignSelf: 'stretch' }}>
                        <View style={styles.containerInner}>
                            ...
                            >
                                <Text style={styles.title}>Zmiana nicku</Text>
                                ...
                                <View style={{ marginTop: -80,marginBottom: 80 }}>
                                    <Text style={styles.text2}>Podaj nowy nick</Text>
                                </View>
                                <View style={
